...
@section('content')
	...
	@if (count($errors) > 0)
		<div class="alert alert-danger fade in">
			<strong>Algo no va bien con el modulo Sedes!</strong> Hay problemas con con los datos diligenciados.<br><br>
				<ul>
	...
	<div class="row">
		<div class="col-md-4">						
			...
			<div class="col-md-11 col-md-offset-1 cuadro">	
				<ul>					
					<dd class="">
						{!! Form::open(array('id'=>'form_search','url' => 'sedes/buscar')) !!}
							{!! Form::label('usuario', 'Buscador de '.Session::get('modulo.modulo'), array('class' => 'col-md-12 control-label')) !!}
							{!! Form::text('names', '', array('class' => 'form-control','placeholder'=>'Ingresa: sede o descripción')) !!}
				...
				<ul>
					...
					<dd style="border-bottom: 1px dotted #78a5b1">
						...
						@foreach (Session::get('modulo.empresas') as $llave_com => $com)
							<li type="square" >{{$com->seat}} : {{$com->total}}</li>
...
@section('script')
	<script type="text/javascript">  	
  		javascript:seg_user.iniciarPie('#container_pie','Distribución de Empresas en Sedes',oli_sede.datos_pie);		
