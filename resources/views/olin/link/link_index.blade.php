...
@section('content')
	...
	@if (count($errors) > 0)
		<div class="alert alert-danger fade in">
			<strong>Algo no va bien con el modulo Vinculos!</strong> Hay problemas con con los datos diligenciados.<br><br>
				<ul>
	...
	<div class="row">
		<div class="col-md-4">						
			...
			<div class="col-md-11 col-md-offset-1 cuadro">	
				<ul>					
					<dd class="">
						{!! Form::open(array('id'=>'form_search','url' => 'vinculos/buscar')) !!}
							{!! Form::label('usuario', 'Buscador de '.Session::get('modulo.modulo'), array('class' => 'col-md-12 control-label')) !!}
							{!! Form::text('names', '', array('class' => 'form-control','placeholder'=>'Ingresa: vinculo o descripcion')) !!}
...
@section('script')
	<script type="text/javascript">  	
  		javascript:seg_user.iniciarPie('#container_pie','Distribución de Afiliados por Vinculo',oli_vinculo.datos_pie);		
