...
@section('content')
	...
	<div class = "alerts">
			...
			@if(Session::has('message'))
				<div class="alert alert-info">
					<strong>¡Modulo Solicitudes!</strong> La operación se ha realizado adecuadamente.<br><br>
					<ul>								
    ...
    {!! Form::open(array('id'=>'form_lugar','url' => 'solicitud/lugar')) !!}
    {!! Form::close() !!}    
	    ...
	    <div class="modal-dialog">	    
	      ...
	      <div class="modal-content">
	        <div class="modal-header">
	          ...
	          <h4 class="modal-title">Modulo Solicitud</h4>
	        </div>
...
@section('script')		
	<script type="text/javascript">  	
		javascript:hom_solicitud.table = $('#example').DataTable( {
		    "responsive": true,
		    "processing": true,
		    "serverSide": true,	        
		    "ajax": "{{url('solicitud/listarajax')}}",	       
		    "columns": [				   
		        { "data": "request_id"},        	            
		        { "data": "name" },
		        { "data": "fhone" },
		        { "data": "identification_headline" },
		        { "data": "state"},
		        { "data": "date"},
		        { "data": "diff"},
		        { "data": "cellfhone", "visible": false},
		        { "data": "cellfhone", "visible": false},
		        { "data": "name_headline", "visible": false},
		        { "data": "seat", "visible": false},
		        { "data": "identification_homage", "visible": false},
		        { "data": "name_homage", "visible": false},
		        { "data": "location_homage", "visible": false},
		        { "data": "orden_service", "visible": false},
		        { "data": "date_service", "visible": false},
		...
		@if(Session::has('filtro'))
			hom_solicitud.table.search( "{{Session::get('filtro')}}" ).draw();
		@endif	
